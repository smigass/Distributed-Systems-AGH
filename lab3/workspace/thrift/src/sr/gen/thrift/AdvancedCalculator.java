...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.19.0)", date = "2026-04-16")
@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
public class AdvancedCalculator {

  public interface Iface extends Calculator.Iface {

    public double op(OperationType type, java.util.Set<Double> val) throws InvalidArguments, org.apache.thrift.TException;

  }

  public interface AsyncIface extends Calculator.AsyncIface {

    public void op(OperationType type, java.util.Set<Double> val, org.apache.thrift.async.AsyncMethodCallback<Double> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends Calculator.Client implements Iface {
    ...
    public void send_op(OperationType type, java.util.Set<Double> val) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends Calculator.AsyncClient implements AsyncIface {
    ...
    public static class op_call extends org.apache.thrift.async.TAsyncMethodCall<Double> {
      private OperationType type;
      private java.util.Set<Double> val;
      public op_call(OperationType type, java.util.Set<Double> val, org.apache.thrift.async.AsyncMethodCallback<Double> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      @Override
      public Double getResult() throws InvalidArguments, org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends Calculator.AsyncProcessor<I> {
    ...
    public static class op<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, op_args, Double> {
      public op() {
        super("op");
      }
      ...
      @Override
      public void start(I iface, op_args args, org.apache.thrift.async.AsyncMethodCallback<Double> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class op_args implements org.apache.thrift.TBase<op_args, op_args._Fields>, java.io.Serializable, Cloneable, Comparable<op_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.Set<Double> val; // required
    ...
    public op_args(op_args other) {
      ...
      if (other.isSetVal()) {
        java.util.Set<Double> __this__val = new java.util.HashSet<Double>(other.val);
    ...
    public void addToVal(double elem) {
      if (this.val == null) {
        this.val = new java.util.HashSet<Double>();
      }
      this.val.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Set<Double> getVal() {
      return this.val;
    }

    public op_args setVal(@org.apache.thrift.annotation.Nullable java.util.Set<Double> val) {
      this.val = val;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case VAL:
        if (value == null) {
          ...
          setVal((java.util.Set<Double>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.val = new java.util.HashSet<Double>(2*_set0.size);
                  double _elem1;
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.val = new java.util.HashSet<Double>(2*_set5.size);
            double _elem6;
