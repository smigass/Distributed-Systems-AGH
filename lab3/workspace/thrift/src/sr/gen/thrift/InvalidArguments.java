...
public class InvalidArguments extends org.apache.thrift.TException implements org.apache.thrift.TBase<InvalidArguments, InvalidArguments._Fields>, java.io.Serializable, Cloneable, Comparable<InvalidArguments> {
  ...
  public InvalidArguments setReason(@org.apache.thrift.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public int compareTo(InvalidArguments other) {
    ...
    lastComparison = Boolean.compare(isSetArgNo(), other.isSetArgNo());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InvalidArguments(");
    boolean first = true;
